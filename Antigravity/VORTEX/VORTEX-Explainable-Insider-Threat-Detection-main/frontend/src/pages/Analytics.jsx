...
const Analytics = () => {
    ...
    if (loading) {
        return (
            <Layout title="Analytics" subtitle="Advanced threat intelligence and patterns">
                        ...
                        <tbody>
                            {trendingUsers.map((user, idx) => (
                                ...
                                >
                                    ...
                                    <td className="py-3 px-4 text-sm">{user.event_count}</td>
                                        ...
                                        {user.is_escalating ? (
                                            <div className="flex items-center space-x-1">
                                                ...
                                                <span className="text-sm text-risk-critical font-semibold">
                                                    +{(user.escalation_rate || user.percent_change || 0).toFixed(0)}%
                                                </span>
                                            </div>
                                        ) : (
