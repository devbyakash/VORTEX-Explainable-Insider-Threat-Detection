...
const Trajectories = () => {
    ...
    if (loading) {
        return (
            <Layout title="Risk Trajectories" subtitle="Monitoring behavioral escalation patterns">
    ...
    return (
        <Layout title="Risk Trajectories" subtitle="Advanced temporal analysis of organizational risk escalation">
            {/* Overview Stats */}
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-gray-800 text-left">
                                    <th className="py-4 px-4 text-[10px] font-black text-gray-500 uppercase">Organizational Identity</th>
                                    <th className="py-4 px-4 text-[10px] font-black text-gray-500 uppercase">Current Risk</th>
                                    <th className="py-4 px-4 text-[10px] font-black text-gray-500 uppercase">Recent Activity</th>
                                    <th className="py-4 px-4 text-[10px] font-black text-gray-500 uppercase">Velocity Shift</th>
                                    <th className="py-4 px-4 text-[10px] font-black text-gray-500 uppercase">Severity</th>
                                    <th className="py-4 px-4 text-[10px] font-black text-gray-500 uppercase">Analysis</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr key={user.user_id} className="hover:bg-gray-800/30 transition-colors group">
                                        ...
                                        <td className="py-4 px-4">
                                            <div className="flex items-center gap-1">
                                                <TrendingUp className={`w-4 h-4 ${user.percent_change > 50 ? 'text-red-500' : 'text-orange-500'}`} />
                                                <span className={`font-black ${user.percent_change > 50 ? 'text-red-500' : 'text-orange-500'}`}>
