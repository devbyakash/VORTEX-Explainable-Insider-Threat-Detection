...
const UserProfile = () => {
    ...
    const captureSnapshot = async () => {
        try {
            ...
            alert(`✅ Snapshot captured!\nTotal events: ${status.total_events}\nHigh risk: ${status.high_risk_events}\nAvg score: ${status.avg_anomaly_score}\n\nNow go inject a threat, then refresh this page to see the delta.`);
        } catch (e) {
    ...
    if (loading) {
        return (
            <Layout title={`System Identity: ${userId}`} subtitle="Decoding behavioral DNA...">
    ...
    return (
        <Layout title={`Agent Identity: ${userId}`} subtitle="Individualized behavioral monitoring and risk trajectory">
            {/* Action Bar */}
                ...
                {simCurrent && (
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        {[
                            ...
                            return (
                                <div key={label} className="bg-gray-950/60 rounded-xl p-3 border border-gray-800">
                                    <div className="text-[10px] text-gray-500 font-black uppercase tracking-widest mb-2">{label}</div>
                                    <div className="flex items-end gap-3">
                                        {hasBefore && (
                                            <div className="text-center">
                                                <div className="text-[9px] text-gray-600 uppercase font-bold mb-1">Before</div>
                                                <div className="text-sm font-mono text-gray-400">{fmt(before)}</div>
                                            </div>
                                        )}
                                        <div className="text-center flex-1">
                                            <div className="text-[9px] text-gray-600 uppercase font-bold mb-1">{hasBefore ? 'After' : 'Current'}</div>
                                            <div className={`text-lg font-black font-mono ${isWorse ? 'text-red-400' : isBetter ? 'text-green-400' : 'text-white'}`}>
                                                {fmt(after)}
                                            </div>
                                        </div>
                                        {delta != null && (
                                            <div className={`text-xs font-bold font-mono ${isWorse ? 'text-red-400' : isBetter ? 'text-green-400' : 'text-gray-500'}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                <div className="lg:col-span-1 card bg-gradient-to-br from-gray-900 to-black border-vortex-accent/30 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center py-4">
                        ...
                        <p className="text-[10px] text-vortex-accent font-bold uppercase tracking-widest mt-1">Verified Organizational Identity</p>
                ...
                <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="card flex flex-col justify-between">
                        ...
                        <div className="mt-4 flex items-center justify-between pt-4 border-t border-gray-800">
                            <span className="text-[10px] font-bold text-gray-500 uppercase">Detection Confidence</span>
                    ...
                    <div className={`card flex flex-col justify-between border-l-4 transition-all ${trajectory.trend?.toLowerCase() === 'escalating'
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-800/30">
                            <div className="flex justify-between items-center">
                                <span className="text-[10px] font-bold text-gray-500 uppercase">Cumulative Score</span>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div className="text-[9px] text-gray-500 uppercase font-bold">Total Operations</div>
                                </div>
                                <div>
                                    <div className="text-2xl font-black text-red-500">{trajectory.summary.high_risk_count}</div>
                                    <div className="text-[9px] text-gray-500 uppercase font-bold">High Risk Events</div>
                                </div>
                            </div>
                        </div>
                        <div className="mt-4 pt-4 border-t border-gray-800">
                            <div className="flex justify-between items-center">
                                <span className="text-[10px] font-bold text-gray-500 uppercase">Alert Chains Detected</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div className="lg:col-span-2 card bg-gray-950/40 relative">
                    ...
                    <div className="flex items-center gap-5 mb-4 px-1">
                        <div className="flex items-center gap-1.5 cursor-default" title="Daily Risk % — how risky this user's activity was each day (0 = normal, 100 = maximum threat)">
                            ...
                            <span className="text-[11px] text-gray-500 font-medium">Daily Risk %</span>
                        </div>
                        <div className="flex items-center gap-1.5 cursor-default" title="Cumulative Threat Load — total suspicious activity building up over time. A steady climb here reveals slow-burn insider threats that never spike on a single day.">
                            ...
                            <span className="text-[11px] text-gray-500 font-medium">Cumulative Load</span>
                        </div>
                        <div className="flex items-center gap-1.5 cursor-default" title="Baseline — this user's normal expected risk level. Days above this line are suspicious.">
                            ...
                            <span className="text-[11px] text-gray-500 font-medium">Baseline</span>
                        </div>
                    </div>
                ...
                <div className="lg:col-span-1 card flex flex-col">
                    ...
                    <p className="text-[10px] text-gray-500 uppercase font-black tracking-widest mb-6">Individualized Feature Attribution</p>
                    ...
                    <div className="space-y-6 flex-1">
                        ...
                        <div className="bg-gray-900/40 rounded-xl p-4 border border-gray-800/50">
                            <h4 className="text-[10px] font-black uppercase tracking-widest text-vortex-accent mb-4">Baseline Comparison (Z-Scores)</h4>
                        ...
                        <div className="p-3 bg-purple-500/5 border border-purple-500/10 rounded-lg">
                            <h5 className="text-[9px] font-black uppercase text-purple-400 mb-1">Observation Note</h5>
            ...
            {(chainsSummary.total_chains > 0 || chains.length > 0) && (
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div className="px-2 py-0.5 bg-orange-500/20 text-orange-400 text-[10px] font-black rounded-md border border-orange-500/30">
                            CRITICAL SIGNAL
                        </div>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 card p-0 overflow-hidden">
                    <div className="p-5 border-b border-gray-800 flex items-center justify-between">
                        ...
                        <span className="text-[10px] font-bold text-gray-500 uppercase">{recentEvents.length} events detected</span>
                    </div>
                    <div className="max-h-[400px] overflow-y-auto custom-scrollbar">
                        <table className="w-full text-left">
                            <thead className="bg-gray-950/50 sticky top-0 z-10 backdrop-blur-md">
                                <tr>
                                    <th className="py-3 px-5 text-[10px] font-black uppercase text-gray-500 tracking-widest">Type/Flag</th>
                                    <th className="py-3 px-5 text-[10px] font-black uppercase text-gray-500 tracking-widest">Timestamp</th>
                                    <th className="py-3 px-5 text-[10px] font-black uppercase text-gray-500 tracking-widest text-right">Risk Score</th>
                                </tr>
                            </thead>
                                        ...
                                        <td className="py-4 px-5">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-[10px] text-gray-500 font-mono uppercase">{event.risk_level} SIGNAL</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="py-4 px-5">
                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="card bg-vortex-accent/5 border-vortex-accent/20">
                        ...
                        <div className="space-y-4">
                            <div className="bg-black/20 p-3 rounded-lg border border-gray-800">
                                <span className="text-[10px] font-bold text-gray-500 uppercase block mb-1">Access Profile</span>
                                <span className="text-xs text-gray-300">Default Organizational User (Tier 2 Analysis)</span>
                            </div>
                            <div className="bg-black/20 p-3 rounded-lg border border-gray-800">
                                <span className="text-[10px] font-bold text-gray-500 uppercase block mb-1">Historical Window</span>
                            ...
                            {escalation && (
                                <div className={`p-3 rounded-lg border flex items-center justify-between ${escalation.is_escalating ? 'bg-red-500/10 border-red-500/30' : 'bg-green-500/10 border-green-500/30'
                                    ...
                                    <span className="text-[10px] font-bold uppercase">Dynamic Escalation</span>
                                    <span className={`text-[10px] font-black uppercase ${escalation.is_escalating ? 'text-red-500' : 'text-green-500'
                                        }`}>
                    ...
                    <div className="card border-dashed border-gray-700 bg-transparent py-4 px-6 flex items-center justify-between">
                        <div className="flex flex-col">
                            <span className="text-[10px] font-black text-gray-500 uppercase">Audit Link</span>
